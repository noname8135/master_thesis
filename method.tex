...
This work presents a method of detecting a compromised switch, and focuses on the problem that a compromised switch will bring. As a defender, we will focus on detection methods of certain scenarios \red{Don't use `certain'. Be specific.}. There are two parts in our work: Flow entry verification method and fake link detection method \sout{\red{What two parts? Name them here.}}. We will define the threat model both parts share, and both parts will be explained along with their attack scenarios and detection algorithm.
